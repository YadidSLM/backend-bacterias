...
--
-- Name: arista uq_arista_from_to_weight; Type: CONSTRAINT; Schema: public; Owner: bacterias_user
--

ALTER TABLE ONLY public.arista
    ADD CONSTRAINT uq_arista_from_to_weight UNIQUE (id_from_node, id_to_node, weight);
